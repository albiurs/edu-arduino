...
float computeDoubleValue(float a);
...
void setup()
{
	...
	print("Call by Pointer (exp 4): ", a2);

	computeDoubleReference(a3);
	print("Call by Reference (exp 6): ", a3);

	print("Call by default Value  (exp 8): ", computeDoubleDefault());
	print("Call by float Value:  (exp 21): ", computeDoubleValue(a105));
}
...
int computeDoubleDefault(int a) {
	return 2 * a;
}
